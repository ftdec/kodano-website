...
export function ConversationScrollButton() {
  ...
  return (
    <button
      ...
      className="absolute bottom-4 left-1/2 -translate-x-1/2 z-10 flex items-center justify-center w-10 h-10 bg-[#3a6a7a]/80 backdrop-blur-sm rounded-full shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110 border border-[#00C8DC]/50 text-white"
