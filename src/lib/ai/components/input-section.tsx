...
export function InputSection({
  ...
  return (
    <div
      className="px-3 sm:px-3 md:px-4 border-t border-gray-200 bg-white backdrop-blur-md rounded-none sm:rounded-bl-3xl [--chat-input-base:0.75rem] sm:[--chat-input-base:1.5rem] md:[--chat-input-base:2rem]"
